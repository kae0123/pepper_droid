...
public class Lesson12 extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    public void onRobotFocusGained(QiContext qiContext) {
        ...
        Transform transform = TransformBuilder.create().fromTranslation(new Vector3(1, 0, 1.2f));
        AttachedFrame attachedFrame = robotFrame.makeAttachedFrame(transform);

        lookAt = LookAtBuilder.with(qiContext)
                .withFrame(attachedFrame.frame())
                .build();
